          ...
          >
            ...
            <div className="container-custom relative h-full flex items-center z-10">
              <div className="max-w-lg text-white">
                <h2
                  className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight"
                  style={{
                    opacity: index === currentSlide ? 1 : 0,
                ...
                <p
                  className="text-base sm:text-lg text-white/80 mb-6 md:mb-8"
                  style={{
                    opacity: index === currentSlide ? 1 : 0,
                    transform: index === currentSlide ? 'translateY(0)' : 'translateY(20px)',
                ...
                <Link
                  to={banner.link}
                  className="btn-primary !bg-white !text-charcoal hover:!bg-terracotta hover:!text-white"
                  style={{
                    opacity: index === currentSlide ? 1 : 0,
                    transform: index === currentSlide ? 'translateY(0)' : 'translateY(20px)',
